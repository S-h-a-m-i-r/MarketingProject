...
const HeroSection = ({
  ...
  return (
    <div className="w-full bg-amber-100">
      <div
        className="relative min-h-screen pt-[10rem] md:pt-[15rem]"
      >
        {/* interior */}
        <div className="relative mx-auto p-1 bg-cover"
          style={{ width, height }}
        >
          <img src={landingBackground} className="mx-auto w-full h-full" />
          <div className="absolute left-[15%] right-[15%] top-[13%] bottom-[8%]">
            <div className="h-[24%] flex items-center justify-between">
              <ClientInfoTooltip placement="top">
                <img
                  src={clock}
                  alt="clock"
                  className="cursor-pointer object-contain transition-all duration-200 ease-in-out hover:scale-y-105 clock-hover-glow h-full"
                ...
                {navigationItems.map((item, index) => {
                  ...
                  return (
                    <div
                      ...
                      className={`!h-full w-[1.5rem] xl:w-[3.125rem] cursor-pointer bg-cover bg-center bg-no-repeat flex items-center justify-center relative group
            ...
            <div className="h-[24%] mt-[15%] flex items-end justify-between">
              <img
                src={phone}
                alt="phone"
                className="h-[60%] ml-1 cursor-pointer transition-all duration-550 hover:ease-in-out hover:scale-y-103 phone-hover-glow"
                onClick={handlephoneClick}
              />
              <div className="flex flex-col justify-end items-center mt-[10px] 2xl:mt-[110px] xl:mt-[90px] lg:mt-[70px]  md:mt-[60px] sm:mt-[40px] h-full">
                <img
                  src={inkPot}
                  alt="inkPot"
                  className="h-[40%] cursor-pointer transition-all duration-300 ease-in-out hover:scale-y-103 inkpot-hover-glow"
                  onClick={handleInkPotClick}
                />
              </div>
              <div className="flex flex-col items-center justify-end h-full cursor-pointer md:pr-15 relative">
                <video
                  ref={sandboxVideoRef}
                  src={sandVideo}
                  className="h-[50%] object-cover rounded-lg mt-4"
                  muted
                  loop
                  playsInline
            ...
            <div className="h-[24%] mt-[15%] flex items-end justify-between">
              <div className="xl:w-[60%] w-[40%]">
                <img
                  src={camera}
                  alt="camera"
                  className="phone-hover-glow w-full"
                  onClick={handleCameraClick}
                />
              </div>
              <div className="flex relative flex-col xl:w-[60%] md:w-[50%] w-[40%] items-center justify-end lg:pt-30 xl:pt-50 md:pt-25 max-sm:pt-12">
                <img
                ...
                <div className="relative">
                  <img
                    src={seeraPng}
                    alt="Seera Box"
                    className=" cursor-pointer phone-hover-glow"
                    onClick={toggleMusic}
                  />
                  {/* Music control icon */}
                  {isMusicPlaying && (
            ...
            <div className="h-[24%] relative">
              <div
                ...
                className={`relative cursor-pointer h-[100%] ${isDrawerScaling ? "t-5 transform-gpu" : ""}`}
